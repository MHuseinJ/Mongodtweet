...
//
    public void show_userline(String username){
        for (Document cur : Userline.find(eq("username",username))) {
            show_tweetid(UUID.fromString(cur.get("tweet_id").toString()));
        }
//
...
//        }
    ...
    public void show_timeline(String username){
        for (Document cur : Timeline.find(eq("username",username))) {
            show_tweetid(UUID.fromString(cur.get("tweet_id").toString()));
        }
...
//
    public void show_tweetid(UUID tweet_id) {
        for (Document cur : Tweets.find(eq("tweet_id", tweet_id))) {
            System.out.println("@"+cur.get("username").toString()+": "+cur.get("body").toString());
        }
